...
impl EnvBackend for EnvInstance {
        ...
        R: scale::Encode,
    {
        ...
        if flags.is_reverted() {
            ...
            panic!("contract returned error with revert flag")
        }
    }
...
impl TypedEnvBackend for EnvInstance {
        ...
        R: scale::Decode,
    {
        ...
        let return_value =
            ink_primitives::MessageResult::<R>::decode(&mut self.engine.exec_context.borrow().output.as_slice())?;
        ...
        R: ConstructorReturnType<ContractRef>,
    {
        ...
        // Same as the happy path of engine::decode_instantiate_result()
        let account_id = scale::Decode::decode(&mut callee.as_slice())?;
        let contract_ref =
